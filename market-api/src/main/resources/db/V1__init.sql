...
(
    ...
    constraint FKil875c0myaxwwf0hty0u1ej2d
        foreign key (board_id) references market.board (id)
);

create table market.like_storage
(
    board_id   bigint not null,
    created_at datetime(6) not null,
    id         bigint auto_increment
...
create table market.member_coupon
(
...
create table market.schedule_task
(
