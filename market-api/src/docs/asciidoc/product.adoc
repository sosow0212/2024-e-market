...
include::{snippets}/product-controller-web-mvc-test/upload_product/request-parts.adoc[]
...
=== 상품을 구매한다 (POST /api/categories/{categoryId}/products/{productId})

==== Request

include::{snippets}/product-controller-web-mvc-test/buy_product/request-headers.adoc[]
include::{snippets}/product-controller-web-mvc-test/buy_product/path-parameters.adoc[]
include::{snippets}/product-controller-web-mvc-test/buy_product/request-fields.adoc[]
include::{snippets}/product-controller-web-mvc-test/buy_product/http-request.adoc[]

==== Response

include::{snippets}/product-controller-web-mvc-test/buy_product/http-response.adoc[]
...
include::{snippets}/product-controller-web-mvc-test/patch_product_by_id/request-parts.adoc[]
